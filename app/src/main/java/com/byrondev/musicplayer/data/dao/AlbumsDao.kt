...
interface AlbumsDao {
    ...
    @Query(""" 
      SELECT
        ...
        a.album_artist, a.release_date, a.num_of_hires_quality, a.duration, a.tracks_total, a.num_tracks,a.created_at,
      COUNT(s.album_id = a.id)  as numTracks, CASE WHEN af.album_id NOT NULL THEN 1 ELSE 0 END as is_favorite FROM albums a
